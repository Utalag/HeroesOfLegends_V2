...
namespace HoL.Aplication.Handlers.Queries.RaceQeries.GetSeqencRaces
{
    ...
    public class GetRaceSeqencQueryHandler : IRequestHandler<GetRaceSeqencQuery, Response<IEnumerable<RaceDto>>>
    {
        ...
        public GetRaceSeqencQueryHandler(IRaceRepository repository, IHttpContextAccessor httpContextAccessor, IMapper mapper)
        {
        ...
        public async Task<Response<IEnumerable<RaceDto>>> Handle(GetRaceSeqencQuery request, CancellationToken cancellationToken)
        {
