...
namespace HoL.Domain.ValueObjects.Anatomi.Stat
{
    ...
    public class Stat : IStatRead, IStatWrite
    {
        ...
        /// </summary>
        public int RawBonus => StatBonusHelper.GetBonus(RawValue);
        /// <summary>
        ...
        /// </summary>
        public int FinalBonus => StatBonusHelper.GetBonus(FinalValue) + BonusAdjustment;


        ///<example>
        /// RawValue = 15
        /// RawBonus = StatModifierTable.GetBonus(15) = 2
        
        /// ValueAdjustment = 2
        /// BonusAdjustment = 1
        
        /// FinlalValue = 15 + 2 = 17
        /// FinalBonus = StatModifierTable.GetBonus(17) + 1 = 3 + 1 = 4
        ///</example> 
